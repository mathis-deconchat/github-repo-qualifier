...
import { GitBranch, Star, GitFork, Calendar, ExternalLink, AlertCircle, User, LogOut } from 'lucide-react';
...
export function Dashboard() {
  ...
  const handleScan = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to scan repositories. Please check your username and try again.';
  ...
  const loadScanHistory = useCallback(async () => {
    ...
    try {
      const history = await trpc.getScanHistory.query();
